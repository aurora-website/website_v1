...
If your installation method is set to **Root** and your **Android version** is **11 (R)**, then you may experience problems with installing apps. A quick 'fix' that works every now and then is to force clear all downloads in the downloads page within Aurora Store and try installing it again. Hope you win the gamble!
...
There is a high possibility that the app you are looking for is geo-locked, meaning it is not accessible either in your country or because the anonymous account you are using has its locale setting set to any potential country other than yours. Read the [Location](/faq/#location) section under the FAQ page.
